...
import sys
sys.path.append("/Users/stighellemans/Desktop/Programming/DataLab/canonical_sets/")
...
class AdultClassifier:
    def __init__(self, data, seed=42):
        ...
        self.train_dl = DataLoader(self.train_dataset, batch_size=32, shuffle=True)
        self.test_dl = DataLoader(self.test_dataset, batch_size=32, shuffle=False)
    ...
    def train_adult_classifier(self, epochs = 1):
        ...
        for epoch in range(epochs):
            ...
            with torch.inference_mode():
                ...
                print(f"Epoch: {epoch} | Train_loss: {train_loss} | Test_loss: {test_loss} | Test_accuracy: {test_acc}")
    ...
    def load_model(self, path):
        ...
        assert path.endswith(".pth") or path.endswith(".pt"), "path to model should end with '.pt' or '.pth'"
